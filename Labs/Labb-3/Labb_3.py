            ...
            if len(circle_list)==0:
                ...
                if choice3>=len(circle_list) or choice3<0:
                    ...
                    if choice4 not in ["1","2","3","4","5","6","7"]:
                        ...
                        x,y=input("Please enter the distances of which you want to move your circle in the X and Y directions").split()
                        x=float(x) if str(float(x))==x or str(int(x))==x else x
                        y=float(y) if str(float(y))==y or str(int(y))==y else y
                        try:
...
shape1=Shape(1,2)
rec1=Rectangle(0.5,0.5,0.5,0.2)
rec2= Rectangle(0.5,0.5,0.5,0.2,20)
